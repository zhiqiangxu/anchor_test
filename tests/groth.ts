...
describe("groth", () => {
  ...
  it("Verify pass!", async () => {
    const args = {
      ...
      proofB: bigIntTo32ByteArray(BigInt("21048401342072133645640261827389021407318800043323648789184189632483499014757")).concat(bigIntTo32ByteArray(BigInt("14452208368547235621759955431055671182948338928173205242401410245941978634491")), bigIntTo32ByteArray(BigInt("2826236686303105505074714778166714863977722649555928550652172904132727281842")), bigIntTo32ByteArray(BigInt("9665592993950276890451117532362737966217051668346780647436469272676562298776"))),
